...
using AspNetCore.UnitTestDemo.Tests;
using AspNetCore.UnitTestDemo.WebUi;
...
{
    [TestClass]
    public class CalculatorControllerFixtureMocks
    {
        ...
        public MockCalculatorService CalculatorServiceInstance
        {
            get
            {
                if (_CalculatorServiceInstance == null)
                {
                    ...
                    _CalculatorServiceInstance.ReturnValue = DEFAULT_RETURN_VALUE;
                }
